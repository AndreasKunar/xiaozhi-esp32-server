...
export class AudioPlayer {
        ...
        try {
            if (typeof window.ModuleInstance === 'undefined') {
                if (typeof Module !== 'undefined') {
                    ...
                    throw new Error('Opus library not loaded, both ModuleInstance and Module objects are missing');
                }
            }
    ...
    enqueueAudioData(opusData) {
        if (opusData.length > 0) {
            ...
            log('Received empty audio data frame, possibly an end marker', 'warning');
    ...
    getAudioStats() {
        ...
        return {
            pendingDecode,  // Pending decode packets
            pendingPlay,    // Pending play packets
    ...
    clearAllAudio() {
        ...
        // Clear the receive queue (use clear method to maintain object reference)
        this.queue.clear();
